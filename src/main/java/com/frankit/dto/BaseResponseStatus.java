...
public enum BaseResponseStatus {
    ...
    FRAN404002(HttpStatus.NOT_FOUND, "Product not found"),
    FRAN404003(HttpStatus.NOT_FOUND, "Product option not found"),
    FRAN405000(HttpStatus.METHOD_NOT_ALLOWED),
    FRAN422000(HttpStatus.UNPROCESSABLE_ENTITY),
    FRAN422001(HttpStatus.UNPROCESSABLE_ENTITY, "A product cannot have more than 3 options"),
